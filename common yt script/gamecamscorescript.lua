...
local defaultPosRateGame = {nil, -600}  -- Position for game cam | Defaults to my preset if untouched 
local defaultPosNumGame = {nil, -600}

local comboThngPos = {nil, -220}        -- You alreaady know
local comboThngPosGame = {nil, -220} 
