...
float cloudDensity = 0.4; 	// overall density [0,1]
float noisiness = 0.95; 	// overall strength of the noise effect [0,1]
float speed = 0.3;			// controls the animation speed [0, 0.1 ish)
...
void mainImage()
{
	...
	fragColor = vec4(q,q,q, 1.0) + texture(iChannel0,uv);
}